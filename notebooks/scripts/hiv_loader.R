...
get_all_data = function() {
    ...
    print('Loaded: hiv_diagnoses, citizenship_status, fpl, income, unemploymen, insured, hospital, federal_funds, test_rate, sex_ed_6_9, sex_ed_9_12, chlamydia, gonorrhea, syphilis')
